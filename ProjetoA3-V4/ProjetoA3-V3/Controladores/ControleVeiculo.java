...
public class ControleVeiculo {
    ...
    //Exibindo  todos atributos de um veiculo.
    private void exibirVeiculoAtributos(Veiculo veiculo) {
        System.out.println("ID: " + veiculo.getIdVeiculo() + "; MODELO: " + veiculo.getModelo() + "; MARCA: "
                + veiculo.getMarca() + "; ANO: " + veiculo.getAno() + "; COR: " + veiculo.getCor() + "; VALOR: "
                + veiculo.getValor());
