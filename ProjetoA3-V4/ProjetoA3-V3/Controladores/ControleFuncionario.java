...
public class ControleFuncionario {
    ...
    //Exibindo todos atributos de um funcionario.
    private void exibirFuncionarioAtributos(Funcionario funcionario) {
        System.out.println("ID: " + funcionario.getIdFuncionario() + "; IDADE: " + funcionario.getIdade() + "; SEXO: "
                + funcionario.getSexo() + "; CPF: " + funcionario.getCpf() + "; ENDEREÇO: " + funcionario.getEndereco()
                + "; SALÁRIO: " + funcionario.getSalario() + "; CARGO: " + funcionario.getCargo());
    }
}
