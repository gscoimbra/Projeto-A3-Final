...
public class ControleCliente {
    ...
    //Exibindo todos atributos de um cliente.
    private void exibirClienteAtributos(Cliente cliente) {
        System.out.println("ID: " + cliente.getIdCliente() + " ; IDADE: " + cliente.getIdade() + " ; SEXO: "
                + cliente.getSexo() + "; CPF: " + cliente.getCpf() + " ; ENDEREÇO: " + cliente.getEndereco()
                + " ; CARTEIRA: " + cliente.getCarteira() + " ; EMAIL: " + cliente.getEmail()
